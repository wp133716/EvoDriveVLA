...
from model.language_models import Qwen2_5_VLForConditionalGeneration_KD
...
os.environ["NO_ALBUMENTATIONS_VERSION_CHECK"] = "1"
...
def train():
    ...
    model = Qwen2_5_VLForConditionalGeneration_KD.from_pretrained(
        ...
        logits_loss=training_args.logits_loss,
        logits_loss_weight=training_args.logits_loss_weight,
        logits_loss_temperature=training_args.logits_loss_temperature,
    ...
    if model_args.train_teacher or training_args.llm_kd:
